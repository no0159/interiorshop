	...
	<table align="center">
		<tr height="60" bgcolor="<%=value_c %>">
			<td rowspan="4" width="150">
				...
				<img src="../../imageFile/<%=bookLists[j].getBook_image() %>" border="0" width="150" height="200"></a></td>
			...
			<td rowspan="4" width="100">
				...
				<%}else{%>
				<font color="blue"><b>제갈공명도 인정한 그 책</b></font>
				<%} %>
			</td>
		</tr>
		...
		<tr height="30" bgcolor="<%=value_c %>">
			<td width="350">정가 :<%=NumberFormat.getInstance().format
			(bookLists[j].getBook_price()) %>원<br>
