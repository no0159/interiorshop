...
<meta charset="UTF-8">
<title>게시판 글목록</title>
<link href="../etc/listSt.css" rel="stylesheet" type="text/css">
</head>
<div class="container">
<body bgcolor="<%=bodyback_c%>">
	...
	<%
		if (count > 0) {
			...
			if (startPage > 10) { %>
				<a class="page" href="list.jsp?pageNum = <%=startPage - 10%>">[이전]</a>
			<%}

			for (int i = startPage; i <= endPage; i++) { %>
				<a class="page" href="list.jsp?pageNum=<%=i%>">[<%=i%>]</a>
			<%}

			if (endPage < pageCount) { %>
				<a class="page" href="list.jsp?pageNum=<%=startPage + 10%>">[다음]</a>
			<% }	
		}%>
</body>
</div>
